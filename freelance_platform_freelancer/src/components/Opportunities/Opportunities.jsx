...
export default function Opportunities() {
    ...
    return (
        <div className="oppMainDiv">
            <p className="ReadexFont oppTitle">A world of <span className="greenText">opportunities</span></p>
            <p className="ReadexFont oppText">We are the most efficient and reliable source of hiring processes and two times faster than any other companies</p>
