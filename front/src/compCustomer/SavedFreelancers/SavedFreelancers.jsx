        ...
        <div className='saved-candidates flex-column align-center'>
            {savedCandidates.length? (
                ...
                {savedCandidates.slice(0,2).map(user =>(
                    <div className='candidate-div' id={user.id}>
                    ...
                    <div className='candidate-inf'>
                        <div className='candidate-name'>
                            <p className='ReadexFont gray'>{user.name}, {user.age} y.o.</p>
            ...
            <Button className="ReadexFont" text="Find a job" backgroundColor="rgb(61,66,90)" color="rgb(255,255,255)" fontSize="16px" width='200px'/>
                </>
            )
            : (
                <p className='ReadexFont uppercase message-saved'>You don't save any {role == 'customer' ? ('freelacer') : ('customer')} </p>
            )}
