            ...
            <div className='main-cart flex-row align-center'>
                ...
                <div className='user-parametrs flex-row  justify-between'>
                        <div className='user-information'>
                            ...
                            <p className='ReadexFont parametrs'>Created account: {new Date(user.user.createdAt).toLocaleDateString('ru-RU')}</p>
                            
                        </div>
                        <div className='flex-column justify-between align-center'>
                            <p className='ReadexFont parametrs'><BasicRating value={5}/></p>
