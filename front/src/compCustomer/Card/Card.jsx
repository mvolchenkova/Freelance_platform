...
export default function Card(props) {
  ...
  const textColor1 =
    alternateColors && id % 2 === 0 ? 'rgb(234, 237, 182)' : text1color || defaultTextColor1;
  const textColor2 =
    alternateColors && id % 2 === 0 ? 'rgb(234, 237, 182)' : text2color || defaultTextColor2;
  const backgroundColorFinal =
    alternateColors && id % 2 === 0 ? 'rgb(61, 66, 90)' : backgroundColor || defaultBackgroundColor;
