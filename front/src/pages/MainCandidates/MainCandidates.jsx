    ...
    <Header/>
        <main className='mainCandidates ReadexFont'>
            ...
            <div className="findNcvDiv">
                <Button text="Find a job" showArrow={true} backgroundColor="rgb(61,66,90)" color="rgb(255,255,255)"/>
                <Link to='/portfolio'>
                    <Button text="Create CV" showArrow={true}  backgroundColor="rgb(255,255,255)" color="rgb(127,135,100)"/>
                </Link>
            </div>  
            ...
            <p className='findJobDescr'>Our state of the art AI handles all the tough work for you. It helps you find the most desired jobs suited to your needs and saves you a lot of valuable time and energy</p>
            <div className='stepsHired'>
                <div className='card1_1'>
                    ...
                    <div className='cardText'>
                        ...
                        <p className='cardDescr'>We are nost efficient and reliable souce of hiring perocess and two time faster than any other companies</p>
                    </div>
                </div>
            ...
            <p className='freshOpportText'><span className='greenText'>Fresh </span>Opportunities</p>
            ...
            <div className='createResumeDiv'>
                <div className='createResumeDescr'>
                    ...
                    <p className='createResDescr'>Our hiring process is so simple and easy to do, just follow the steps and you’re done!</p>
                    <Button text='Get started' showArrow={true} backgroundColor="rgb(61,66,90)" color="rgb(255,255,255)"></Button>
                </div>
