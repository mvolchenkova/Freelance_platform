        ...
        <div className="poweredByContainer">
            ...
            <div className="PoweredByDiv ReadexFont">
                <div className="description">
                    ...
                    <p className="powByText">We are offering an alternative route towards the traditional hiring process. What do we want in return? Sign up and leave the rest to us.</p>
                    <Button showArrow="true" text="Get started"
                    backgroundColor="rgb(61,66,90)" color="white"></Button>
                </div>
                <div>
