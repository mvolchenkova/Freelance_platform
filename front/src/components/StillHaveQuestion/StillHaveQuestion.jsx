    ...
    return(
        ...
        <article className="have-question">
            <div className='header-faq question'>
                ...
                <p className='small-letters ReadexFont width'>If you cannot find answer to your question in our FAQ, you can always contact us.
                We wil answer to you shortly!</p>
            </div>
